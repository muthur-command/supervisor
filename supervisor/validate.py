...
SCHEMA_UPDATER_CONFIG = vol.Schema(
    {
        ...
        vol.Optional(ATTR_MCOS): version_tag,
        vol.Optional(ATTR_MCOS_UNRESTRICTED): version_tag,
        vol.Optional(ATTR_MCOS_UPGRADE): vol.Schema(
        ...
        vol.Optional(ATTR_IMAGE, default=dict): vol.Schema(
            {
                vol.Optional(ATTR_MUTHURCOMMAND): docker_image,
