...
class Swap(DBusServiceMock):
    ...
    gdbus introspect --system --dest io.muthurcommand.os --object-path /io/muthurcommand/os/Config/Swap
    """

    object_path = "/io/muthurcommand/os/Config/Swap"
    interface = "io.muthurcommand.os.Config.Swap"
